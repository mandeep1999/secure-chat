...
if(isset($_POST["register"]))
{
	...
	if($statement->execute($check_data))	
	{
		...
		else
		{
			...
			if(empty($key)){
				$message .= '<p><label>Personal key is required</label></p>';

			}
			if($key){
				if(strlen($key) >26){
					$message .= '<p><label>Personal key cannot be greater than 26 characters</label></p>';
				}
			}
			else
			{
			...
			/*	$data = array(
				...
				$query = "
				INSERT INTO login 
				(username, password,key2) 
				VALUES (:username, :password,:key2)
				";
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form method="post" 
						...
						<label>Personal key</label>
						<div class="form-group">
							<input type="text" name="key" class="form-control" placeholder="maximum 26 characters"  />
						</div>
						<div class="form-group">
